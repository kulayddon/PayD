...
test('README includes a three-step quick start section', () => {
  ...
  assert.match(readme, /3\.\s+\*\*Create your local environment and start the app\*\*/);
  assert.ok(readme.indexOf('1. **Clone and enter the repo**') < readme.indexOf('2. **Install dependencies**'));
  assert.ok(
